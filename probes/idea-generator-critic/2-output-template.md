...
ascii_example: |
  ...
  └──────┬──────┘
         │
  ┌──────▼──────┐
  │ Graph Model │ (file relationships)
  └──────┬──────┘
         │
  ┌──────▼──────┐
...
types:
  ...
  - Cross-domain: "Urban traffic patterns applied to request routing"
...
good:
  ...
  - "WebGPU compute shaders for parallel simulation"
...
- [ ] Index number (NNNN) recorded in footer
